...
M.PHASE_ORDER = {
  "IDLE", "QUEUED", "EXPORTING_TOPOLOGY", "EXPORTING_TERMINALS", "EXPORTING_VEHICLES",
  "EXPORTING_TRACK_NETWORK", "EXPORTING_TERRAIN_BOUNDS", "EXPORTING_TERRAIN_ROWS", "WRITING_FINAL_JSON",
...
function M.phaseLabel(phase, job)
  ...
  local labels = {
    ...
    EXPORTING_TRACK_NETWORK = "Schienennetz / Linienpfade",
...
function M.computeProgress(job)
  ...
  local weights = {
    QUEUED = 0.01,
    EXPORTING_TOPOLOGY = 0.08,
    EXPORTING_TERMINALS = 0.06,
    EXPORTING_VEHICLES = 0.05,
    EXPORTING_TRACK_NETWORK = 0.08,
    EXPORTING_TERRAIN_BOUNDS = 0.02,
    EXPORTING_TERRAIN_ROWS = 0.64,
    WRITING_FINAL_JSON = 0.04,
  }
  ...
  local order = {
    ...
    M.EXPORT_PHASE.EXPORTING_TRACK_NETWORK,
